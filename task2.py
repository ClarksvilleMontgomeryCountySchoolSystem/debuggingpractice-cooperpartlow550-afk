...
candy_total = (f"{candy_price} * {candy_quantity}")
...
soda_total = (f"{soda_price} * {soda_quantity}")
...
deli_price = 8.99
pounds = pounds_str
deli_total = (f"{deli_price} * {pounds}")
...
lottery_total = (f"{lottery_price} * {lottery_quantity}")
